...
const DEFAULT_SHORTCUTS = [
  ...
  { id: 'tool.boxSelect',    label: '框选站点工具',   defaultBinding: 'B', category: '工具', when: 'mapEditor' },
  { id: 'tool.boxSelectEdges', label: '框选线段工具', defaultBinding: 'Shift+B', category: '工具', when: 'mapEditor' },
