...
- **MapContextMenu.vue** — 地图右键上下文菜单（模式切换、站点/线段/锚点就地操作，模式文案使用“添加站点/添加线段/连续布线/命名布线”等全称）
...
- **mapLayers.js** — 地图图层管理（ensureMapLayers、ensureSources、updateMapData、线路样式表达式构建、站名/线路名/换乘标记显隐控制，含分区覆盖/人口热力/主干道高亮等叠加图层；布线类模式会显示全部站点）
